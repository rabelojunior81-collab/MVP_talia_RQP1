      ...
      const sessionPromise = ai.live.connect({
        ...
        callbacks: {
          ...
          onmessage: async (message: LiveServerMessage) => {
            ...
            if (audioData) liveAudio.playAudioChunk(audioData);
          ...
          onclose: () => { setIsConnected(false); liveAudio.stopRecording(); },
          onerror: () => { setIsConnected(false); liveAudio.stopRecording(); }
        }
      });
